...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `migration_id` = '20250428120736_AddNewProductTable') THEN
    ...
    CREATE TABLE `new_product` (
        ...
        `price` int NOT NULL,
        CONSTRAINT `pk_new_product` PRIMARY KEY (`id`)
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`migration_id`, `product_version`)
    VALUES ('20250428120736_AddNewProductTable', '8.0.2');
